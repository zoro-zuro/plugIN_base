  ...
  if (!isSignedIn) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
        ...
        {/* Login Card */}
        <div className="w-full max-w-md bg-card/80 backdrop-blur-xl border border-border rounded-2xl p-8 shadow-2xl relative z-10 text-center animate-in fade-in zoom-in duration-300">
          {/* Icon */}
          ...
          <p className="text-muted-foreground mb-8 text-sm leading-relaxed">
            You need to be signed in to access the <strong>PlugIN RAG</strong>{" "}
            dashboard and manage your AI agents.
          </p>
